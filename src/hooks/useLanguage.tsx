...
const translations = {
  sv: {
    ...
    // Pet Logs
    "petlog.title": "Min djurlogg",
    "petlog.loginPrompt": "Logga in för att spara personliga anteckningar om ditt djur",
    "petlog.login": "Logga in",
    "petlog.timerAndReminders": "Timer & Påminnelser",
    "petlog.timer": "Tidtagare",
    "petlog.start": "Starta",
    "petlog.pause": "Pausa",
    "petlog.reset": "Återställ",
    "petlog.save": "Spara",
    "petlog.labelActivity": "Aktivitet",
    "petlog.labelFeeding": "Matning",
    "petlog.labelHandling": "Hantering",
    "petlog.labelCleaning": "Rengöring",
    "petlog.labelObservation": "Observation",
    "petlog.reminders": "Mina påminnelser",
    "petlog.newReminder": "Ny påminnelse...",
    "petlog.quickSuggestions": "Snabbförslag:",
    "petlog.noReminders": "Inga påminnelser ännu",
    "petlog.pending": "Väntande",
    "petlog.completed": "Klara",
    "petlog.defaultReminder1": "Glöm inte mata {name}!",
    "petlog.defaultReminder2": "Byt vatten för {name}",
    "petlog.defaultReminder3": "Rengör {name}s boende",
    "petlog.defaultReminder4": "Kontrollera temperaturen",
    "petlog.defaultReminder5": "Hantera {name} idag",
    "petlog.addNote": "Lägg till anteckning",
    "petlog.notePlaceholder": "Vad gjorde du idag?",
    "petlog.selectType": "Välj typ",
    "petlog.typeFeeding": "Matning",
    "petlog.typeCleaning": "Rengöring",
    "petlog.typeHealth": "Hälsa",
    "petlog.typeOther": "Övrigt",
    "petlog.saving": "Sparar...",
    "petlog.saved": "Sparat!",
    "petlog.error": "Kunde inte spara",
    "petlog.yourLogs": "Dina anteckningar",
    "petlog.noLogs": "Inga anteckningar ännu",
    "petlog.date": "Datum",
    "petlog.type": "Typ",
    "petlog.note": "Anteckning",
    "petlog.delete": "Ta bort",
    "petlog.confirmDelete": "Är du säker på att du vill ta bort denna anteckning?",
  },
  en: {
    // Navigation
    ...
    // Pet Logs
    "petlog.title": "My pet log",
    "petlog.loginPrompt": "Log in to save personal notes about your pet",
    "petlog.login": "Log in",
    "petlog.timerAndReminders": "Timer & Reminders",
    "petlog.timer": "Timer",
    "petlog.start": "Start",
    "petlog.pause": "Pause",
    "petlog.reset": "Reset",
    "petlog.save": "Save",
    "petlog.labelActivity": "Activity",
    "petlog.labelFeeding": "Feeding",
    "petlog.labelHandling": "Handling",
    "petlog.labelCleaning": "Cleaning",
    "petlog.labelObservation": "Observation",
    "petlog.reminders": "My reminders",
    "petlog.newReminder": "New reminder...",
    "petlog.quickSuggestions": "Quick suggestions:",
    "petlog.noReminders": "No reminders yet",
    "petlog.pending": "Pending",
    "petlog.completed": "Completed",
    "petlog.defaultReminder1": "Don't forget to feed {name}!",
    "petlog.defaultReminder2": "Change water for {name}",
    "petlog.defaultReminder3": "Clean {name}'s habitat",
    "petlog.defaultReminder4": "Check temperature",
    "petlog.defaultReminder5": "Handle {name} today",
    "petlog.addNote": "Add note",
    "petlog.notePlaceholder": "What did you do today?",
    "petlog.selectType": "Select type",
    "petlog.typeFeeding": "Feeding",
    "petlog.typeCleaning": "Cleaning",
    "petlog.typeHealth": "Health",
    "petlog.typeOther": "Other",
    "petlog.saving": "Saving...",
    "petlog.saved": "Saved!",
    "petlog.error": "Could not save",
    "petlog.yourLogs": "Your logs",
    "petlog.noLogs": "No logs yet",
    "petlog.date": "Date",
    "petlog.type": "Type",
    "petlog.note": "Note",
    "petlog.delete": "Delete",
    "petlog.confirmDelete": "Are you sure you want to delete this log?",
  },
  de: {
    // Navigation
